          ...
          {!isFetchingUsers && (
            <div className="p-2 flex flex-col h-full gap-4 lg:items-center lg:p-8">
              ...
              {users.map((user) => (
                <div
                  key={user.id}
                  className="p-4 grid grid-cols-12 auto-rows-[50px] gap-3 rounded-2xl shadow-[0_1px_2px] h-60 lg:h-44 justify-between border-l-4 border-primary  bg-white lg:w-3/4 "
                >
                  ...
                  <div className="col-span-12 row-span-1  flex flex-wrap justify-end">
                    <Link
                      className="text-primary tracking-[-0.5] underline font-semibold px-2"
