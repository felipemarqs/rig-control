...
export const FormMenu = () => {
  const {temporaryEfficiencies, navigate, isFetchingTemporaryEfficiencies} =
    useListUsers();
            ...
            <div className="p-2 flex flex-col h-full gap-4 lg:items-center lg:p-8">
              ...
              <div className="w-full mt-8">
                <span className="font-semibold text-2xl tracking-[-0.5px] block text-center  text-gray-600">
                  Boletins de Ocorência salvos
                </span>
              </div>

              {temporaryEfficiencies.map((efficiency) => (
                <div
                  key={efficiency.id}
